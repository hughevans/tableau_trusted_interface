...
module TableauTrustedInterface
  class Report
    ...
    def initialize(options = {})
      ...
      @auth_server = options.fetch(:auth_server, TableauTrustedInterface.config.default_auth_server || options.fetch(:server, TableauTrustedInterface.config.default_server))
      @view_server = options.fetch(:view_server, TableauTrustedInterface.config.default_view_server || options.fetch(:server, TableauTrustedInterface.config.default_server))
